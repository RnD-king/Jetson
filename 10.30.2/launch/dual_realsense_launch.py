...
def launch_setup(context, params, param_name_suffix=''):
    ...
    node_params = {
        'rgb_camera.enable_auto_white_balance': auto_white_balance,
        'rgb_camera.enable_auto_exposure': False,
        'rgb_camera.exposure': exposure,
    }

    if white_balance is not None:
        node_params['rgb_camera.white_balance'] = white_balance
    ...
    return [
        launch_ros.actions.Node(
            ...
            parameters=[params, params_from_file, node_params],
            output=_output,
...
def generate_launch_description():
    ...
    cam1_overrides = {
        ...
        # 'rgb_camera.enable_auto_exposure': 'true',  ## ##weklejqwkleqwekljqwekl
        # infra/imu 추가로 off
