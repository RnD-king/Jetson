...
class BasketballDetectorNode(Node):
    def __init__(self):
        ...
        self.roi_y_start = self.image_height * 1 // 3
        self.roi_y_end   = self.image_height
    ...
    def image_callback(self, color_msg: Image, depth_msg: Image):
        ...
        cv2.putText(frame, self.last_position_text, (self.roi_x_start, self.roi_y_start - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (170, 80, 215), 2)
