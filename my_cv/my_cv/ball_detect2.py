...
from my_cv_msgs.msg import MotionEnd, LineResult #, BallAdjust  # type: ignore
...
class BasketballTrackerNode(Node):
    ...
    - cam2 단계: BallAdjust(status, dx, dy, r) 퍼블리시(미세 정렬)
    """
    ...
    def __init__(self):
        ...
        self.pub_cam2 = self.create_publisher(PointStamped, '/ball_adjust_cam2', 10)   # status, dx, dy, r
